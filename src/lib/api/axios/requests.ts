...
export const getStatusRemoteJob = async (): Promise<RemoteJobStatusState[]> => {
  // const { data } = await client.get<RemoteJobStatusState[]>(API_URL.GET_STATUS_REMOTE_JOB_LIST);
  ...
  return [
    {
      ...
      siteId: 1,
      stop: true,
      companyName: 'CANON-CA1',
      fabName: 'CA1',
      companyFabName: 'CANON',
      jobName: 'TEST1',
      lastSuccess: {
        stepId: 1,
        enable: true,
        ...
        historyId: 'abc-1',
        stepType: 'collect',
        stepName: 'cellcet-test',
        endDate: '2012-12-17 11:11:11',
      },
      lastFailure: {
        stepId: 1,
        enable: true,
...
export const getStatusRemoteJobStep = async (jobId: number): Promise<RemoteJobStepStatus[]> => {
  // const { data } = await client.get<RemoteJobStepStatus[]>(API_URL.GET_STATUS_REMOTE_JOB_STEP_LIST(jobId));
  // return data;
  ...
  return [
    {
      ...
      status: 'success',
      error: [],
      stepName: 'convert_test1',
      stepType: 'convert',
      description: 'convert_test1234',
      lastSuccess: {
        stepId: 1,
        enable: true,
        description: 'aaaa',
    ...
    },
    {
      ...
      status: 'failure',
      error: [],
      stepName: 'collect_test1',
      stepType: 'collect',
      description: 'collect_test1234',
      lastSuccess: {
        stepId: 1,
        enable: true,
        description: 'aaaa',
    ...
    steps: [
      {
        ...
        selectJudgeRules: [
          {
            itemId: 1,
            itemName: '(running_rate)running_rate',
            enable: true,
          },
        ],
